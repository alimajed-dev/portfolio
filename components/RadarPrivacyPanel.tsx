...
const SECTIONS = [
  ["Information processed", "Up to 10 recent public posts per scan, including post text and identifiers, timestamps, public author details, and public engagement metrics returned by X. Protected posts, Direct Messages, email addresses, private metrics, and precise location data are not accessed."],
  ["How it is used", "The radar ranks professional conversations for possible manual participation. It never posts, replies, likes, reposts, follows, or messages anyone."],
  ...
  ["Storage and removal", "Only the latest successful result set is cached privately, and its public display expires within 24 hours. New successful scans replace it. Account owners may request correction or removal at any time."],
