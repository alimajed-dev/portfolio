...
function scoreExplanation(post: RankedPost) {
  ...
  const { reach, engagement, velocity, relevance } = post.signals;
  return `Views ${post.metrics.impressions ?? 0} (reach ${reach}) · interactions ${interactions} (quality ${engagement}) · velocity ${velocity} · relevance ${relevance}. Green: 70+, orange: 55–69, red: below 55.`;
}
