...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex size-9 shrink-0 items-center justify-center rounded-md text-neutral-600 transition-[background-color,color,transform] duration-150 hover:scale-105 hover:bg-panel hover:text-accent active:scale-95 lg:size-8"
    >
      {targetTheme === "dark" ? (
