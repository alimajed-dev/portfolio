...
describe("RadarProcessPanel", () => {
  it("explains the hybrid ranking pipeline and weights", () => {
    ...
    expect(screen.getByText(/source-control and dependency trade-offs/i)).toBeTruthy();
    ...
    expect(screen.getByText(/quoted source is expanded in the same response/i)).toBeTruthy();
