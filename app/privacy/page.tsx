  ...
  return <article className="min-h-0 flex-1 overflow-y-auto px-4 py-6 sm:px-6 lg:py-12">
    <div className="mx-auto max-w-[680px]">
      ...
      <div className="mt-8 space-y-7 text-[13px]/[1.65] text-neutral-600 sm:text-[14px]/[1.65]">
        ...
        <section><h2 className="text-base font-semibold text-ink">Storage and removal</h2><p className="mt-2">Only the latest successful result set is cached privately. Public display expires within 24 hours unless refreshed. New successful scans replace the previous cache. Content that is deleted, protected, suspended, withheld, or otherwise unavailable will be removed or updated as soon as reasonably possible. X or the applicable account owner may request removal at any time.</p></section>
